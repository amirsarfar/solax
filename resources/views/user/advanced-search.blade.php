        ...
        <section>
            <div class="row mt-3">
                <div class="col-md-4 order-2 order-md-1">
                    <div class="bg-black-75 rounded p-3 mt-2 border-warning">
                        <h6>جستجو شده :</h6>
                        @for($i=1; $i<8;$i++)
                                <span class="align-items-baseline d-inline-block mt-2 rounded p-1 text-black-50 bg-black-85 "> <i
                                        class="fas fa-times pl-1"></i>واقعیت مجازی</span>
                        @endfor
                    </div>
                    <div class="bg-black-75 rounded p-3 mt-2 border-warning">
                ...
                <div class="col-md-8 order-1 order-md-2">
                    <div class="bg-black-75 p-3 rounded">
                        <div class="d-flex flex-column-reverse flex-md-row">
                            ...
                            <div class="input-group mr-md-2">
                                <input type="text" class="form-control bg-black-75 text-white border-warning"
                                       placeholder="بازی مورد نظر تو را جستجو کن" aria-label="Recipient's username"
                                       aria-describedby="basic-addon2">
                                <div class="input-group-append">
                                    <span class="input-group-text bg-warning" id="basic-addon2"><i
                    ...
                    <div class="bg-black-75 p-3 mt-2 rounded">
                        ...
                        <div class="d-flex justify-content-center">
                            <span class="p-2 mt-3 mx-1">1</span>
                            <span class="p-2 mt-3 mx-1">2</span>
                            <span class="p-2 mt-3 mx-1">3</span>
                            <span class="p-2 mt-3 mx-1">4</span>
                            <span class="p-2 mt-3 mx-1">5</span>
                            <span class="p-2 mt-3 mx-1">6</span>
                            <span class="p-2 mt-3 mx-1 border-black-50 text-warning">7</span>
                        </div>
                        </div>
                    </div>
